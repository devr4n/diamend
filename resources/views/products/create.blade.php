            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group focused">
                        ...
                        <select id="operation_type_id" class="form-control select2" name="operation_type_id" required>
                            <option value="">{{ __('general.form.select') }}</option>
                ...
                <div class="col-lg-4">
                    <div class="form-group focused">
                        ...
                        <select id="product_type_id" class="form-control select2" name="product_type_id" required>
                            <option value="">{{ __('general.form.select') }}</option>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea id="description" class="form-control textAreaMultiline" name="description" maxlength="100"
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group focused">
                        ...
                        <select id="material_type_id" class="form-control select2" name="material_type_id" required>
                            <option value="">{{ __('general.form.select') }}</option>
                            @foreach($materialTypes as $materialType)
                                <option value="{{ $materialType->id }}">{{ $materialType->localized_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
